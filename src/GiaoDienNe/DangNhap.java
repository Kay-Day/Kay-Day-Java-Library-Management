...
import Connect.DocGia_Connect;
import Connect.DocGia_Connect_implement;
...
public class DangNhap extends javax.swing.JFrame {
    ...
    private JComboBox<String> txt_chucVu;
    private JPasswordField txt_matKhau;
    private JTextField txt_tenDangNhap;
    /////
    private JButton Themcot;
////////////////////////////////////////////////
    private javax.swing.JButton btn_them;
    DocGia_Connect getDogia = new DocGia_Connect_implement();
    public DangNhap() {
        initComponents();
    }
...
//        btn_them= new javax.swing.JButton();
        ...
        setTitle("Đăng nhập vào hệ thống thư viện VKU");
...
//////////////////////////////////////////////////////////////////////////////////////
        Themcot.setBackground(new Color(255,255,125));
        Themcot.setFont(new Font("Time New Roman",0,18));
//        Themcot.setSize(100,100);
        Themcot.setText("Thêm");
        ...
        btn_Thoat.setBackground(new java.awt.Color(255, 69, 0));
        ...
        txt_chucVu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Độc giả", "Chủ thư" }));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/BOOK1.png"))); // NOI18N
    ...
    private void txt_matKhauActionPerformed(java.awt.event.ActionEvent evt) {
...
//        Tôi muốn thêm KeyEventListener vào JButton phản hồi với phím Enter, bằng cách sử dụng đoạn mã sau:
        if (evt.getKeyCode() ==0) {
            if(txt_tenDangNhap.getText().equals("") || txt_matKhau.getPassword().equals("")){
                JOptionPane.showMessageDialog(null, "Bạn chưa nhập đủ thông tin!");
            }
