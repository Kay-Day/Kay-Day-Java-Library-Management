...
import GiaoDienNe.TrangChuDocGia;
...
public class TrangChuDocGia_ChiTietSach extends javax.swing.JFrame {
    ...
    public Sach_Dv sachServices = new Sach_Dv();
    ...
    private void initComponents() {
        ...
        jLabel14.setForeground(new java.awt.Color(255,127,80));
        ...
        lblNoiDung.setForeground(new java.awt.Color(255,127,80));
...
//        Đường line
        jScrollPane2.setBorder(BorderFactory.createLineBorder(Color.orange));
        ...
        lblTenSach.setForeground(new java.awt.Color(255,127,80));
    ...
    private void btnThoatCTActionPerformed(java.awt.event.ActionEvent evt) {
        this.dispose();
    }

    private void btnThemMuonActionPerformed(java.awt.event.ActionEvent evt) {
        this.dispose();
